...
// CORS configuration
const corsOptions = {
    origin: ['http://localhost:5173', 'https://contribution-to-adhi-s-life-1.onrender.com', 'https://user-management-system-meadble-adhithiyaa.vercel.app'], // Vite default port
